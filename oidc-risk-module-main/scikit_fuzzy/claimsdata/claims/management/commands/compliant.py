...
class Command(BaseCommand):
    help = 'Populate the database with initial claims data with gdpr_compliance set to 1.0'
    ...
    def handle(self, *args, **kwargs):
        ...
        education_claims = [
            ...
            {"claim_designation": "profile", "impact": 0.55, "gdpr_compliance": 1.0},
            {"claim_designation": "email", "impact": 0.85, "gdpr_compliance": 1.0},
            {"claim_designation": "phone", "impact": 0.85, "gdpr_compliance": 1.0},
        ...
        self.stdout.write(self.style.SUCCESS('Successfully populated the database with gdpr_compliance set to 1.0'))
