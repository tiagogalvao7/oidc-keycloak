...
To customize this screen, you need to change the [login.ftl](https://github.com/NGI-TRUSTCHAIN/OIDC-PRINCE/tree/main/oidc-keycloak-theme-testversion/themes/custom-theme/custom.v2/login/login.ftl) file (it really needs to have this name, so that Keycloak knows that this screen is for the login screen), which has then been styled by [style.css](https://github.com/NGI-TRUSTCHAIN/OIDC-PRINCE/tree/main/oidc-keycloak-theme-testversion/themes/custom-theme/custom.v2/login/resources/css/style.css).
